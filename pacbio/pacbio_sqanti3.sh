#!/bin/bash
#SBATCH --job-name=pacbio_sqanti3
...
snakemake -s sqanti3.smk --profile slurm --jobs 100 --rerun-incomplete --rerun-triggers mtime --config recollapsed_directory=recollapsed
